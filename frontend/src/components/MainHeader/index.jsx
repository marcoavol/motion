...
const MainHeader = () => {
    ...
    const mockAvatar = getMockAvatar(true)
    ...
    return (
        <MainHeaderContainerStyled>
            <nav id="nav-bar">
                ...
                <Link id="profile-link" to="/profile"><ButtonRoundStyled><img src={user.avatar ? user.avatar : mockAvatar} alt="Avatar" /></ButtonRoundStyled></Link>
